package com.jcampoy.liferay.samples.model;
...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(com.jcampoy.liferay.samples.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.jcampoy.liferay.samples.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public com.jcampoy.liferay.samples.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public com.jcampoy.liferay.samples.model.Foo toUnescapedModel() {
